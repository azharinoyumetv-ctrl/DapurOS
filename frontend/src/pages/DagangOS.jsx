    ...
    <div className="min-h-screen bg-[hsl(var(--background))] text-[hsl(var(--foreground))] selection:bg-[hsl(var(--accent))/0.2] relative">
      ...
      <section id="products" className="py-20 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 max-w-4xl mx-auto gap-8">
          ...
          {/* Active: DapurOS */}
          <div className="card-surface p-8 flex flex-col justify-between border-2 border-amber-600/20 hover:border-amber-600 hover:shadow-lg transition-all duration-300 relative bg-white">
            <span className="absolute top-4 right-4 pill pill-success">Tersedia</span>
            <div>
            ...
            <Link to="/dapuros" className="btn-primary w-full mt-8 py-2.5 flex items-center justify-center gap-2 text-xs bg-amber-600 hover:bg-amber-700 border-amber-600 text-white font-semibold rounded-lg shadow-sm">
              Kunjungi Web App <ArrowRight size={14} />
            </Link>
          </div>
        </div>
