...
import { Leaf, Check, ArrowRight, ChevronDown, Utensils } from "lucide-react";
...
export default function Pricing() {
  ...
  const brandName = isDapurOS ? "DapurOS" : "Geraina";
  ...
  return (
    <div data-testid="pricing-page" className={isDapurOS ? "theme-dapuros min-h-screen bg-amber-50/10" : ""}>
      <header className="border-b border-[hsl(var(--border))] bg-white">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/" className="font-display text-xl font-extrabold flex items-center gap-2" data-testid="pricing-nav-logo">
            <BrandIcon className="text-[hsl(var(--accent))]" size={22} /> {brandName} <span className="text-[hsl(var(--muted))] text-sm font-medium">by DagangOS</span>
          </Link>
