...
export default function Pricing() {
  ...
  return (
    <div data-testid="pricing-page" style={{ fontFamily: JK, background: "#fffaf6", color: BODY, minHeight: "100vh" }}>
      {/* Nav */}
      ...
      <section className="pt-16 sm:pt-20 pb-8 text-center px-5 sm:px-8" data-testid="pricing-hero">
        ...
        <p className="mt-4 max-w-xl mx-auto" style={{ color: BODY }}>
          Pilih paket yang cocok dengan ukuran usaha Anda. Bisa naik atau turun paket kapan saja.
        </p>
      ...
      <section className="py-10 px-5 sm:px-8">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-5 gap-4">
          {tiers.map((t) => (
            <div key={t.id} className="rounded-2xl bg-white p-6 flex flex-col relative" style={{ border: t.highlight ? `2px solid ${ORANGE}` : `1px solid ${LINE}` }} data-testid={`pricing-card-${t.id}`}>
