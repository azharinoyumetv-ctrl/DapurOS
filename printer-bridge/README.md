...
```
DapurOS Printer Bridge listening on http://127.0.0.1:9899
```

## Setting it up in DapurOS
...
4. Leave **Bridge Port** as `9899` unless you changed `DAPUROS_BRIDGE_PORT`.
...
- **"Gagal mengirim test print" in DapurOS**: make sure this script is still running, and that `Bridge Port` in Settings matches the port this script printed on startup.
